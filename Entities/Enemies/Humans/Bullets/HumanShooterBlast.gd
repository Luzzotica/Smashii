...
func _ready():
	...
	$BulletOuter.modulate = Constants.humanShooterBlastColor
	$ParticleTrail.modulate = Constants.humanShooterBlastColor
	$DeathNodes/BlastDeathParticles.modulate = Constants.humanShooterBlastColor
